    ...
    public partial class ints : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, 0, "fe20606c-16e0-41f3-a08b-843bfc2fd262", 0L, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "admin@localhost.com", true, false, null, "", "ADMIN@LOCALHOST.COM", "ADMIN@LOCALHOST.COM", "AQAAAAIAAYagAAAAEEDIfDigVI7Nr1F+8YGxMuC8+vzf/vuBEKMzyFieQXm5+pNma9FPJ8nGWhaQecuVyg==", null, false, "f4af9ea6-3ab7-42fd-abbc-dff42672b08c", false, null, null, "admin@localhost.com" },
                    { 2L, 0, "88d70dbb-0fd4-47b7-aca6-76573643888e", 0L, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "employee@localhost.com", true, false, null, "", "EMPLOYEE@LOCALHOST.COM", "EMPLOYEE@LOCALHOST.COM", "AQAAAAIAAYagAAAAEMpouQyjZCGX19M+uKEMgJ+cMUHzYZ1E52JbNMKEONhHhkPaJxyAr2nbKtsLXCuXrg==", null, false, "15003cee-54e5-4575-9b1b-53e8079b87ff", false, null, null, "employee@localhost.com" }
                });
